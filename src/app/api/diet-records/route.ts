  ...
  try {
    ...
    await connection.execute(`
      CREATE TABLE IF NOT EXISTS diet_records (
        ...
        food_type ENUM('dry', 'wet', 'treat', 'homemade', 'other') DEFAULT 'dry',
        amount VARCHAR(50),
        calories INT,
        notes TEXT,
...
export async function GET(request: NextRequest) {
  try {
    ...
    sql += ' ORDER BY record_date DESC, FIELD(meal_type, "breakfast", "lunch", "dinner", "snack")';
...
// DELETE /api/diet-records - 删除饮食记录
