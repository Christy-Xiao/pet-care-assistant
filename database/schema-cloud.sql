-- 云端数据库建表脚本（TiDB Cloud）
-- 在已有数据库中创建所有表，不包含 CREATE DATABASE
...
-- 插入示例数据
INSERT IGNORE INTO pets (id, name, species, breed, gender, date_of_birth, age, weight, notes) VALUES
('pet_1', '球球', 'dog', '金毛', 'male', '2023-01-15', 3, 30.5, '性格温顺，喜欢玩球');

INSERT IGNORE INTO care_schedules (id, pet_id, title, description, event_type, due_date, priority) VALUES
...
INSERT IGNORE INTO health_records (id, pet_id, type, title, description, result) VALUES
('record_1', 'pet_1', 'analysis', '皮肤问题分析', '肚皮发红，疑似湿疹', '{"summary": "皮肤轻微炎症，建议保持干燥清洁", "issues": ["轻度皮肤炎"], "severity": "mild", "suggestions": ["保持皮肤干燥", "使用温和洗护用品"]}');

INSERT IGNORE INTO park_locations (id, name, address, latitude, longitude, features, rating, distance) VALUES
